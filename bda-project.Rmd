...
To really visualise predictions, we plot predicted delays and true delays on the same plot. From the plot we can see, that although the model has converged well, it has no real prediction power. The models forecast essentially the same number all the time.
